...
export async function POST(request) {
  try {
    ...
    const initialPositions = [
      { point: 23, color: 'WHITE', count: 2 },
      { point: 12, color: 'WHITE', count: 5 },
      { point: 7, color: 'WHITE', count: 3 },
      { point: 5, color: 'WHITE', count: 5 },
      { point: 0, color: 'BLACK', count: 2 },
      { point: 11, color: 'BLACK', count: 5 },
      { point: 16, color: 'BLACK', count: 3 },
